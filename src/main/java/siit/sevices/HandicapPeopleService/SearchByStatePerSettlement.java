...
@Service ("searchByStatePerSettlementHandicap")
public class SearchByStatePerSettlement extends AlgorithmsHandicap implements SearchablePerSettlementHandicap {
    @Override
