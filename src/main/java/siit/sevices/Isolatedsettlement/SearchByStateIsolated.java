...
import siit.sevices.Isolatedsettlement.SearcableIsolated;

import java.util.ArrayList;
import java.util.List;

@Service("searchByStateIsolated")
public class SearchByStateIsolated extends Algorithms implements SearcableIsolated {
    @Autowired
    ...
    public List<IsolatedPeople> search(String name) {
        List<IsolatedPeople> peoplesSelected = isolatedPeopleService.getIsolatedPeople(comunneService.getTempString());
